	...
	return (
		<Container className="w-50 mt-5">
			...
			<div className="fs-5 fw-light mb-5">
				...
				reviewers to sending back a completely annotated paper back to the
				journal. The process overview is described in Figure 2. It will recruit
				trained scientists, provide training to the inexperienced ones, utilize
				a Skepsi-like software for the reviewing process, match papers to
				relevant reviewers, pay them the fee after deducting administrative
				costs, conduct randomized quality control checks, maintain a reviewer
			...
			<div className="fs-5 fw-light">
				...
				{" "}which outlines the complete problem statement, our solution formation
				with detailed justification, and addressal of counter-arguments. For
